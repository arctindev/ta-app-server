      ...
      var w = b(function (e, t) {
        ...
        return i.a.createElement(r.e.Consumer, null, function (e) {
          ...
          _ &&
            ...
            (R = Object(l.a)({}, R, f)));
          var N = Object(l.a)(
            { 'aria-current': (_ && o) || null, className: T, style: R, to: a },
            P
          );
          return (
                  ...
                  switch (t.label) {
                    ...
                    case 9:
                      return [
                        2,
                        (($.error =
                          ((V.data = t.sent()), (V.error = String(Q)), V)),
                        ($.meta = n),
                        $),
                      ];
                    case 10:
                      return [
                        ...
                        _(D, q)
                          ? { data: q, meta: n }
                          : { error: { status: D.status, data: q }, meta: n },
                      ];
                  }
                });
              });
            ...
            buildMutationSelector: function () {
              return function (e) {
                var t = Object(u.a)(a, function (t) {
                  ...
                  return null !=
                    (r =
                      e === z || null == (n = null == t ? void 0 : t.mutations)
                        ? void 0
                        : n[e])
                    ? r
                    : U;
            ...
            return function (e) {
              return function (t) {
                return function (n) {
                  var r = t(n);
                  return (
                    R.match(n) && a(e, 'refetchOnFocus'),
                    A.match(n) && a(e, 'refetchOnReconnect'),
                    r
                  );
                };
              };
                    ...
                    buildMutationHook: function (e) {
                      return function (n) {
                        ...
                        Object(a.useEffect)(function () {
                          return function () {
                            var e;
                            null == (e = O.current) || e.unsubscribe(),
                              (O.current = void 0);
                          };
                        }, []);
    ...
    function (e, t, n) {
      ...
      function Sa(e) {
        ...
        function c(e, t, n, r) {
          return null !== t && t.elementType === n.type
            ...
            : (((r = Vl(n.type, n.key, n.props, null, e.mode, r)).ref = ka(
                e,
                t,
                n
              )),
        ...
        function d(e, t, n) {
          ...
          if ('object' === typeof t && null !== t) {
            switch (t.$$typeof) {
              case O:
                return (
                  ((n = Vl(t.type, t.key, t.props, null, e.mode, n)).ref = ka(
                    e,
                    null,
                    t
                  )),
                ...
                e: {
                  ...
                  a.type === E
                    ? (((r = Wl(a.props.children, e.mode, l, a.key)).return =
                        e),
                      (e = r))
                    : (((l = Vl(a.type, a.key, a.props, null, e.mode, l)).ref =
                        ka(e, r, a)),
                      (l.return = e),
                      (e = l));
                }
      ...
      function au(e) {
        switch (e.tag) {
          ...
          case 3:
            if ((Na(), uo(fo), uo(so), Ha(), 0 !== (64 & (t = e.flags))))
              throw Error(i(285));
      ...
      function Su(e, t) {
        switch (t.tag) {
          ...
          case 13:
            return (
              null !== t.memoizedState && ((Qu = qo()), vu(t.child, !0)),
              void Eu(t)
            );
          case 19:
            return void Eu(t);
      ...
      function pl(e, t) {
        ...
        if (((r = Dt(e, e === Tu ? Nu : 0)), (t = It), 0 === r))
          ...
          15 === t
            ? ((n = yl.bind(null, e)),
              null === zo ? ((zo = [n]), (Do = Eo(To, Ho))) : zo.push(n),
              (n = Mo))
            : 14 === t
      ...
      function hl(e) {
        ...
        if (
          ...
          switch (
            ...
            case 3:
              if (
                (vl(e, n), (62914560 & n) === n && 10 < (r = Qu + 500 - qo()))
              ) {
                if (0 !== Dt(e, 0)) break;
      ...
      function El(e, t) {
        ...
        if ((ea(), (_u = n), (ju.current = r), null !== Ru))
          throw Error(i(261));
      ...
      function Rl() {
        for (; null !== Bu; ) {
          ...
          ll ||
            ...
            (0 !== (8 & Bu.flags)
              ? et(Bu, ul) && (ll = !0)
              : 13 === Bu.tag && xu(e, Bu) && et(Bu, ul) && (ll = !0));
          var t = Bu.flags;
          0 !== (256 & t) && pu(e, Bu),
            0 === (512 & t) ||
              Yu ||
      ...
      function Dl(e, t, n) {
        ...
        null !== r && r.delete(t),
          ...
          Tu === e &&
            (Nu & n) === n &&
            (4 === Mu || (3 === Mu && (62914560 & Nu) === Nu && 500 > qo() - Qu)
              ? kl(e, 0)
              : (Uu |= n)),
          pl(e, t);
      }
      ...
      function Kl(e, t, n) {
        return (
          ((t = ql(4, null !== e.children ? e.children : [], e.key, t)).lanes =
            n),
          (t.stateNode = {
        ...
        try {
          for (
            ...
            if ('function' === typeof i) {
              ...
              (n = t.unstable_now()),
                'function' === typeof u ? (T.callback = u) : T === E(j) && x(j),
                M(n);
            } else x(j);
            T = E(j);
          }
